...
let btcAddress = "bc1qexample";
let conversionRate = 0.00001 / 10000;
...
function prestige() {
    if (mins >= 10000) {
        ...
        alert("Need 10,000 Mins to prestige.");
    }
}
...
function exportBTC() {
    if (mins >= 10000) {
        ...
        link.download = "btc_payout.txt";
        link.click();
        mins -= 10000;
        updateUI();
    } else {
        alert("Need 10,000 Mins to export payout.");
    }
}
